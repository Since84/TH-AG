...
(function($){
	...
	$.widget("dynamite.feature_slider",{
		...
		options: {
			...
			sliderWindowClass: '.slide-window',
			slideWidth: '1000px'
		},
		...
		nextSlide: function(elem){
			...
			if ( !$( self.options.sliderClass ).is(':animated') ) {
				...
				var pagerSpacing = $( self.options.sliderClass ).parents('.feature-slider').find('.paging').width() ;
...
jQuery(document).ready(function(){
	jQuery('.feature-slider').feature_slider();
})